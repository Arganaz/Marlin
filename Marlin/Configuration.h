 ...
 */
#define TEMP_SENSOR_0 1 // 5 quando for E3D
...
#define HEATER_0_MAXTEMP 275 // 300 para apertar aos 285 qundo for E3D
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS 16  // Initial brightness (0-255)
